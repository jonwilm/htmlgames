var options = ["Gano", "Ups", "Gano", "Ups", "Gano", "Ups", "Gano",
"Ups", "Gano", "Ups", "Gano", "Ups", "Gano", "Ups", "Gano", "Ups", "Gano",
"Ups"];
...
function dibujarRuleta() {
  ...
  if (canvas.getContext) {
    ...
    optRuleta.strokeStyle = "black";
    optRuleta.lineWidth = 2;
    optRuleta.font = '12px Verdana, Arial';
    for(var i = 0; i < options.length; i++) {
      var angle = inicioAngulo + i * arc;
      optRuleta.fillStyle = getColor2RGB(i, options.length);
      optRuleta.beginPath();
      optRuleta.arc(150, 150, outsideRadius, angle, angle + arc, false);
      optRuleta.arc(150, 150, insideRadius, angle + arc, angle, true);
      optRuleta.stroke();
      optRuleta.fill();
      optRuleta.save();
      ...
      optRuleta.translate(150 + Math.cos(angle + arc / 2) * textRadius,
    ...
    optRuleta.beginPath();
    optRuleta.moveTo(150 - 4, 150 - (outsideRadius + 5));
    optRuleta.lineTo(150 + 4, 150 - (outsideRadius + 5));
    optRuleta.lineTo(150 + 4, 150 - (outsideRadius - 5));
    optRuleta.lineTo(150 + 9, 150 - (outsideRadius - 5));
    optRuleta.lineTo(150 + 0, 150 - (outsideRadius - 13));
    optRuleta.lineTo(150 - 9, 150 - (outsideRadius - 5));
    optRuleta.lineTo(150 - 4, 150 - (outsideRadius - 5));
    optRuleta.lineTo(150 - 4, 150 - (outsideRadius + 5));
    optRuleta.fill();
...
function detenerRotacionRuleta() {
  ...
  optRuleta.fillText(text, 150 - optRuleta.measureText(text).width / 2, 150 + 10);
